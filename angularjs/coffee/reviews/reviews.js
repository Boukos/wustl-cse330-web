angular.module('coffeeApp.reviews', ['ngRoute'])
.config(['$routeProvider', function($routeProvider) {
	$routeProvider.when('/reviews/:coffeeId', {
		templateUrl: 'reviews/reviews.html',
		controller: 'reviewsctrler'
	});
}])
.controller('reviewsctrler', ['$scope', '$routeParams',
	function($scope, $routeParams) {
		...
		$scope.coffees.forEach(function(coffeeitem){
			if(coffeeitem.id == $routeParams.coffeeId) {
				$scope.coffee = coffeeitem;
				$scope.reviews = coffeeitem.reviews;
			}
		});	
}]);